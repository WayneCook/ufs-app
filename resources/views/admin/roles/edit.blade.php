...
<div class="box box-warning">
    <div class="box-header with-border custom-tools">
        ...
        <div>
            <form role="form" method="POST" action="{{ action('Admin\RolesController@destroy', ['id' => $role->id]) }}">
                {{ csrf_field() }}
                {{ method_field('DELETE') }}
                <div class="btn-group">
    ...
    <form method="post" action="{{ action('Admin\RolesController@update', ['id' => $role->id]) }}">
